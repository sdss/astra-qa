...
This page is showing results from APOGEENet III. [See here for APOGEENet II results.](pipelines_apogeenet_v2.html)
:::
...
APOGEENet [@apogeenet_1; @apogeenet_2; @apogeenet_3] uses a convolutional neural network to estimate stellar labels ($T_\mathrm{eff}$, $\log{g}$, and metallicity [Fe/H]) given a rest-frame resampled APOGEE spectrum.
...
fig = qa.plot_kiel_two_panel(*data.T, x_lims=(3_000, 20_000))
```
...
### Calibrated error
```{python}
fig = qa.plot_z_scores("ApogeeNet")
```
